/*
东东水果:脚本更新地址 https://raw.githubusercontent.com/MichaelPei/scripts/master/jd_fruit.js
更新时间：2020-11-30
...
[task_local]
#jd免费水果
5 6-18/6 * * * https://raw.githubusercontent.com/MichaelPei/scripts/master/jd_fruit.js, tag=东东农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "5 6-18/6 * * *" script-path=https://raw.githubusercontent.com/MichaelPei/scripts/master/jd_fruit.js,tag=东东农场

=========================Surge============================
东东农场 = type=cron,cronexp="5 6-18/6 * * *",wake-system=1,timeout=120,script-path=https://raw.githubusercontent.com/MichaelPei/scripts/master/jd_fruit.js

=========================小火箭===========================
东东农场 = type=cron,script-path=https://raw.githubusercontent.com/MichaelPei/scripts/master/jd_fruit.js, cronexpr="5 6-18/6 * * *", timeout=200, enable=true
...
!(async () => {
  await requireConfig();
  if (!cookiesArr[0].cookie) {
    $.msg($.name, '【提示】请先获取京东账号一cookie\n直接使用NobyDa的京东签到获取', 'https://bean.m.jd.com/', {"open-url": "https://bean.m.jd.com/"});
    return;
  }
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i].cookie) {
      cookie = cookiesArr[i].cookie;
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    if ($.isNode()) {
      ...
      cookiesArr.push(...JSON.parse($.getdata('CookiesJD') || '[]'));
    }
